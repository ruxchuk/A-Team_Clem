...
{
    public partial class UCReportEmployeeClem : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void setGridView()
        {
            ...
            gridView1.Columns["employee_clem"].Caption = "1. พนักงาน-ผู้ส่งเคลม";
            gridView1.Columns["company_receive_clem"].Caption = "2. บริษัท-ผู้รับเคลม";
            gridView1.Columns["company_return"].Caption = "3. บริษัท-ผู้คืนของ";
            gridView1.Columns["employee_receive_product"].Caption = "4. พนักงาน-ผู้รับของ";
            gridView1.Columns["employee_return"].Caption = "5. พนักงาน-ผู้คืนของ";
            gridView1.Columns["customer_receive_product"].Caption = "6.ลูกค้า-ผู้รับของ";
            ...
            gridView1.Columns["customer_name_th"].Visible = false;
            gridView1.Columns["address"].Visible = false;
            gridView1.Columns["phone"].Visible = false;
            gridView1.Columns["in_serial_clem"].Visible = false;
            gridView1.Columns["out_serial_clem"].Visible = false;
            gridView1.Columns["customer_clem"].Visible = false;
            gridView1.Columns["employee_receive_clem"].Visible = false;
            gridView1.Columns["warranty"].Visible = false;
            gridView1.Columns["chargebacks"].Visible = false;
        ...
        {
            readData();
            DataSet list = conDB.getListClem(fRMMain.addEmployeeClem.clemType);
            if (list != null)
            {
        ...
        private void gridView1_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (e.Clicks == 2)
            {
                try
                {
                    ...
                    fRMMain.addEmployeeClem.Dispose();
