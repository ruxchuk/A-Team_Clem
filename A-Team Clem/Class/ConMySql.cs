            ...
            if (CheckConnect())
            {
                try
                {
                    string sql = @"
                        ...
                        AND publish = 1
                    ";
                    sql += customerID == 0 ? "" : " AND id=" + customerID;
                    sql += @"
                        ORDER BY id
                        ;
                    ";
            ...
            if (CheckConnect())
            {
                try
                {
                    string sql = @"
                        ...
                        AND publish = 1
                    ";
                    sql += companyID == 0 ? "" : " AND id=" + companyID;
                    sql += company_name_th == "" ? "" : " AND icompany_name_th LIKE='%" + company_name_th + "%'";
                    sql += company_phone == "" ? "" : " AND phone LIKE='%" + company_phone + "%'";
                    sql += @"
                        ORDER BY id
                        ;
                    ";
            ...
            if (CheckConnect())
            {
                try
                {
                    string sql = @"
                        ...
                        WHERE 1
                    ";
                    sql += productTypeID == 0 ? "" : " AND id=" + productTypeID;
                    sql += @"
                        AND publish = 1
                        ORDER BY id
                    ";
            ...
            if (CheckConnect())
            {
                try
                {
                    string sql = @"
                        ...
                        AND publish = 1
                    ";
                    sql += productID == 0 ? "" : " AND id=" + productID;
                    sql += @"
                        ORDER BY id
                        ;
                    ";
            ...
            if (CheckConnect())
            {
                try
                {
                    string sql = @"
                        ...
                        AND publish = 1
                    ";
                    sql += employeeID == 0 ? "" : " AND id=" + employeeID;
                    sql += @"
                        ORDER BY id
                        ;
                    ";
        ...
        public int addClem()
        {
            ...
            if (CheckConnect())
            {
                try
                {
                    ...
                    while (dataReader.Read())
                    {
                        clemID = int.Parse(dataReader["last_id"].ToString());
                    }
                    dataReader.Close();
                    Debug.WriteLine("last id: " + clemID);
                }
                catch
                {
                    CloseConnection();
            ...
            if (CheckConnect())
            {
                ...
                {                  
                    ...
                    if (customerID == 0)
                    {
                        ...
                        while (dataReader.Read())
                        {
                            customerID = int.Parse(dataReader["last_id"].ToString());
                        }
                        dataReader.Close();
                        //clemID = (int)cmd.LastInsertedId;
                        Debug.WriteLine("last id: " + customerID);
                    }
                    else
                    {
                        customerID = 0;
            ...
            if (CheckConnect())
            {
                ...
                {                    
                    ...
                    if (companyID == 0)
                    {
                        ...
                        while (dataReader.Read())
                        {
                            companyID = int.Parse(dataReader["last_id"].ToString());
                        }
                        dataReader.Close();
                        Debug.WriteLine("last id: " + companyID);
                    }
                    else
                    {
                        companyID = 0;
            ...
            if (CheckConnect())
            {
                try
                {
                    ...
                    if (employeeID == 0)
                    {
                        ...
                        while (dataReader.Read())
                        {
                            employeeID = int.Parse(dataReader["last_id"].ToString());
                        }
                        dataReader.Close();
                    }
                    else
            ...
            if (CheckConnect())
            {
                ...
                {                    
                    ...
                    if (productID == 0)
                    {
                        ...
                        while (dataReader.Read())
                        {
                            productID = int.Parse(dataReader["last_id"].ToString());
                        }
                        dataReader.Close();
                    }
                    else
            ...
            if (CheckConnect())
            {
                ...
                {                    
                    ...
                    if (productTypeID == 0)
                    {
                        ...
                        while (dataReader.Read())
                        {
                            productTypeID = int.Parse(dataReader["last_id"].ToString());
                        }
                        dataReader.Close();
                    }
                    else
